...
public:
  ...
  typedef TriangleMeshSourceType::IdentifierType TriangleMeshSourceIdentifierType;
  typedef TriangleMeshSourceType::IdentifierArrayType TriangleMeshSourceIdentifierArrayType;
  ////////////////////////////////////////////////////////////////////////////////////
...
protected:
  ...
  ////////////////added by me/////////////////////////////////////////////////////////////
  TriangleMeshSourceType::Pointer	      m_TriangleMeshSource;		
  vtkCutter*  							  m_SurfaceCutter;
  vtkStripper*							  m_cutStripter;
  vtkPlane*								  m_cutPlaneAxial;
  vtkPlane*								  m_cutPlaneSagittal;
  vtkPlane*								  m_cutPlaneCoronal;
  vtkPolyData*                            m_vtkMesh;   //the surface in vtk format
  vtkPolyData*                            m_vtkContour;  //the cutted contour
  VolumeType::Pointer                m_LoadedPreprocessed;
  VolumeType::Pointer                m_LoadedOriginal;
  VolumeReaderType::Pointer          m_PreprocessedReader;
  double Level0StepLen;
  double Level0StepNum;
  double Level0Iter;
  double Level1StepLen;
  double Level1StepNum;
  double Level1Iter;
  double Level2StepLen;
  double Level2StepNum;
  double Level2Iter;
  double Level3StepLen;
  double Level3StepNum;
  double Level3Iter;
  double Level4StepLen;
  double Level4StepNum;
  double Level4Iter;
  ////////////////////////////////////////////////////////////////////////////////////////
