...
extern IntrimResultCounter;  //a counter for output the interim results
...
class DeformableModelApplication : public DeformableModelApplicationGUI
{
 public:
  ...
  virtual void SaveMesh(char* , char* );
  virtual void LoadMesh();
  virtual void LoadMesh(char*);
  ...
  virtual void LoadPreprocessed(); //added by me
  virtual void LoadPreprocessed(char*); //added by me
  virtual void ToggleImage(); //added by me
 ...
 private:
  ...
  bool m_ImageLoaded;
  bool m_PreprocessedLoaded; //added by me
  int m_WhichImage; //added by me, 0: no image shown; 1: original shown; 2: preprocessed shown
  bool m_MeshLoaded;
  bool m_MeshCreated;
